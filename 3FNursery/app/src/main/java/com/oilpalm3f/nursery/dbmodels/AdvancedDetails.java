...
public class AdvancedDetails {
    ...
    private  int FarmerContributionPriceForIndigenousSaplings;
    ...
    public int getFarmerContributionPriceForIndigenousSaplings() {
        return FarmerContributionPriceForIndigenousSaplings;
    }

    public void setFarmerContributionPriceForIndigenousSaplings(int farmerContributionPriceForIndigenousSaplings) {
