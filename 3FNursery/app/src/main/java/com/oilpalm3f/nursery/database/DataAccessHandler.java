            ...
            if (cursor != null && cursor.moveToFirst()) {
                do {
                    ...
                    if (filelocation != null) {
                        ...
                        nurseryVisitLogDetails.setLatitude(cursor.getString(cursor.getColumnIndex("Latitude")));
                        nurseryVisitLogDetails.setLongitude(cursor.getString(cursor.getColumnIndex("Longitude")));
